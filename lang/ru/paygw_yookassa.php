...
$string['reccurent'] = 'Включить регулярные платежи';
$string['reccurent_help'] = 'Регулярные (рекурентные) платежи исполняются по таймеру без участия студента, данные первого платежа сохраняются на стороне банка и используются повторно, с некоторой периодичностью.';
$string['reccurentperiod'] = 'Периодичность регулярного платежа';
